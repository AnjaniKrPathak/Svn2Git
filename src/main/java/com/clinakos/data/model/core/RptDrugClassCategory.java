 ...
 *
 */
public class RptDrugClassCategory {
	private int id;
	private int providerId;
	private String DrugCategory;
	private int totalDrug;
	private Date ReportDateForDrugClass;
	...
	/**
	 * @return the reportDateForDrugClass
	 */
	public Date getReportDateForDrugClass() {
		return ReportDateForDrugClass;
	}
	/**
	 * @param reportDateForDrugClass the reportDateForDrugClass to set
	 */
	public void setReportDateForDrugClass(Date reportDateForDrugClass) {
		ReportDateForDrugClass = reportDateForDrugClass;
	}
	/**
