...
public interface IDashBoardService {
	...
	List<String> userInsuranceDetails(int id);

	List<String> findPatientProviderClinicList(int id);

	List<PatientDiagnosesDetails> findDiagnosisDetailList(int id);

	PatientVital findParticularPatientVitalDetail(int id);

	List<ViewFunctionalDetails> findViewFunctionDetailList(int id);

	List<LOVType> findLovTypeListInDetail();

	List<PatientDiagnosesDetails> getPatientDiagnosesDetails();

	PatientVital getLoggedPatientVitalData();

	//List<LoginSecurity> getUserPassword(String email);
	...
	List<DiagnosesChart> getDiagnosesChartList();
	
	//List<UserLoginDetail> finduserListForadmin();

	//List<String> findUserDetailsForAdmin();
	
	List<FormularyChart> findFormularyChart();
	
	List<PatientCountForDrugGene> getPatientDrugGeneList();
	...
	int getTotalDoctor(int limitFlag, int logedUserId, String logedUserFirstName,
			String logedUserLastName);
	...
	void savePatientEditProfile(UserLoginDetail userLoginDetail,EmployerDetails patientEmployerDetails,PatientVital patientVital,
			...
			List<PatientProviderClinic> temporaryDeleteClinicListProfile, List<PatientDiagnosesDetails> editPateintProfileDiagosesList,List<PatientDiagnosesDetails> temporaryAddDiagnosesEditProfileList,List<PatientDiagnosesDetails> deleteDiagnosesEditProfileList, 
	...
	List<UserLoginDetail> fetchListForOncology(String levelVal, int logedUserId);
	...
	void updatePasswordResetDate(int forgotPasswordSendingLinkId);
	...
	List<UserLoginDetail> fetchPatientsForEnbrelConcurrentMeds(int providerId,
			String rangeName, double drugId, double drugNameId);
